...
const Home: React.FC = () => {
  return (
    ...
    <section className=" lg:static w-full lg:h-screen flex items-center justify-center lg:mb-0">
      {/* Image as element */}
      <img
        src="Images/background.jpg"
        alt="Background"
        className="relative lg:static top-0 left-0 w-full lg:h-screen"
      />

      {/* Foreground content */}
      <div
        className="absolute  lg:block text-center text-white px-4 top-16 left-21 sm:top-[25%] sm:left-[35%]"
