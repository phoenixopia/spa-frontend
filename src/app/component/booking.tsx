...
const BookingPage = () => {
  return (
    <div><h2 className="text-3xl font-extrabold text-center text-[#717171] mb-6">
    Reservation
  </h2>
        ...
        <form action="#" className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                className="w-full p-3 rounded-lg shadow-sm focus:ring-white focus:border-white bg-[#814589] text-white"
          ...
          <button
            type="submit"
            className="w-full py-3 text-white font-medium bg-[#9C26A3] rounded-lg hover:bg-purple-600 focus:ring-4 focus:ring-pink-300"
          >
            Book Now
          </button>
        </form>
