    ...
    <section className="text-gray-600 body-font relative overflow-x-hidden">
      <div className="container mx-10 lg:px-30 py-14 relative">
        <div className="lg:w-2/3 flex flex-col items-start ml-4">
          {/* Title */}
          <h1 className="font-Italianno text-[#633466] text-6xl font-extrabold mb-10 w-full">
            Opening Hours
          </h1>

          {/* Time details */}
          <div className="w-full mb-6">
            <h2 className="text-[#633466] font-Italianno text-4xl font-bold mb-2 w-full">
              Monday to Sunday
            </h2>
            <h2 className="text-[#633466] font-Italianno text-4xl font-bold w-full">
...
<div className="flex justify-end w-full mb-6 pr-10">
  <a href="/booking" className="flex-shrink-0">
    <button className="text-white bg-[#633466] border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">
      Book Now
      <svg
